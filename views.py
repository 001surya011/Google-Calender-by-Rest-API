...
# This variable --> file that containing the OAuth 2.0
# information of client_id and client_secret.
...
def GoogleCalendarRedirectView(request):
    ...
    # and other tools which interacts with the interact with Google APIs.

    # The Discovery API provides a list of Google APIs

    service = googleapiclient.discovery.build(
        API_SERVICE_NAME, API_VERSION, credentials=credentials)

    # Returns the calendars on the user calendar list
    ...
    # Getting all events associated with a email address
